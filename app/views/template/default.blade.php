    ...
    <body>
        ...
        <footer class='container'>
            <p class='text-center'>  
                ...
                Projeye {{ HTML::link('http://www.github.com/ibrahimhizlioglu/laravel-ornek-uygulama', 'GitHub ', array('target' => '_blank')) }} üzerinden katkıda bulunabilirsiniz.
                Bu örnek uygulama {{ HTML::link('http://www.ibrahimhizlioglu.com/', 'İbrahim Hızlıoğlu ', array('target' => '_blank')) }} tarafından hazırlanmıştır.
            </p>
        </footer>
